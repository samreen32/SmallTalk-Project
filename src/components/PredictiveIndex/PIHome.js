  ...
  return (
    <>
      ...
      <div style={{ padding: "7% 10%" }}>
        <h2 className="md-8">
          <b>
            Liberty Iberoamerica SLU has requested that you complete a
        ...
        <form>
          ...
          <div className="mb-3 form-check">
            ...
            <label className="form-check-label" for="exampleCheck1">
              I have already taken the PI Behavioral Assessment and would like
              to enter my Behavioral Score ID.
            </label>
            {showInput && (
              <>
                <p className="my-5">
                  <b>
                    Please enter your Behavioral Score ID in the following box.
                    We recommend searching your email account for "The
                    Predictive Index" to find your Score ID from your completed
                    assessment.
                  </b>
                  <TextField
                    variant="outlined"
