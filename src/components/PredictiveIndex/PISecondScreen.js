        ...
        <form>
          ...
          <div className="mb-3 my-5">
            ...
            <div className="form-check">
              ...
              <label className="form-check-label" for="flexRadioDefault4">
                Based on data or metrics and completely free of personal
                opinion.
              </label>
            </div>
            <div className="form-check">
            ...
            <div className="form-check">
              ...
              <label className="form-check-label" for="flexRadioDefault7">
                Based on personal experience or opinion and mostly free of data
                or metrics.
              </label>
            </div>
            <div className="form-check">
          ...
          <div className="mb-3 my-5">
            <label for="exampleInputEmail1" className="form-label">
              <h8>
                <b>
                  Your company is considering a big change in strategic
                  direction. Senior leaders ask you for your opinion. Which of
                  the following are you most likely to do when providing
                  feedback? *
                </b>
              </h8>
            </label>
          ...
          <div className="mb-3 my-5">
            <label for="exampleInputEmail1" className="form-label">
              <h8>
                <b>
                  You have been tasked with organizing the company holiday
                  party. In choosing a location, which of the following are you
                  most likely to do? *
                </b>
              </h8>
            </label>
